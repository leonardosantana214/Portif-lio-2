			...
			<div class="animated-box">
				...
				<div id="content">
					<article id="manned-flight">
						...
						<hr />
						<a href="Sobre-nos.html" class="btn-Link fade-link">Sobre-nos</a>
					...
					<article id="about">
						...
						<?php if ($_SESSION['email'] != "") : ?>
							<div class="user-info">
								<?php $imagem = $_SESSION['image']; ?>
								<img src="frutas/<?php echo $_SESSION['image']; ?>" Align="center" id="img-user" alt="Imagem do usuário" style="border-radius:50%; margin-right:20px; " width="100px" height="100px">
